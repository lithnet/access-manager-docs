...
| Access to encrypted local admin passwords set by the Lithnet Access Manager Agent <sup>1</sup>  | <img src="/images/green_circle_tick.png" data-size="line"> | <img src="/images/green_circle_tick.png" data-size="line"> |
...
| Feature                                                                                              |                                                                           Community Edition                                                                           |                                                                           Enterprise Edition                                                                          |
| ---------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| Manage local admin passwords and store them in Active Directory (domain-joined Windows clients only) | <img src="/images/green_circle_tick.png" data-size="line"> | <img src="/images/green_circle_tick.png" data-size="line"> |
| Manage local admin passwords and store them in the Access Manager database                           | <img src="/images/green_circle_tick.png" data-size="line"> | <img src="/images/green_circle_tick.png" data-size="line"> |
| Encrypted storage of passwords                                                                       | <img src="/images/green_circle_tick.png" data-size="line"> | <img src="/images/green_circle_tick.png" data-size="line"> |
| Retain historical local admin password history                                                       | <img src="/images/green_circle_tick.png" data-size="line"> | <img src="/images/green_circle_tick.png" data-size="line"> |
