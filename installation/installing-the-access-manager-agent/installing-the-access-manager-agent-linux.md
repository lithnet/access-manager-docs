...
The agent is built using Microsoft .NET 10. Ensure the distribution you are using is supported. See the [Microsoft guide for supported operating systems for .NET 10](https://github.com/dotnet/core/blob/main/release-notes/10.0/supported-os.md) for more information.
...
curl -L https://packages.lithnet.io/linux/rpm/packages/access-manager-agent/v3.1/noarch/stable -o ~/accessmanager-data.rpm
sudo dnf install ~/accessmanager-data.rpm

# Download the x64 Access Manager Agent
curl -L https://packages.lithnet.io/linux/rpm/packages/access-manager-agent/v3.1/x64/stable -o ~/accessmanager.rpm
...
```shell
# Download the Access Manager Agent data package
curl -L https://packages.lithnet.io/linux/deb/packages/access-manager-agent/v3.1/noarch/stable -o ~/accessmanager-data.deb
sudo apt install ~/accessmanager-data.deb

# Download the x64 Access Manager Agent
curl -L https://packages.lithnet.io/linux/deb/packages/access-manager-agent/v3.1/x64/stable -o ~/accessmanager.deb
