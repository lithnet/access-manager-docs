...
2. [.NET Desktop Runtime](https://dotnet.microsoft.com/en-us/download/dotnet/10.0/runtime) 10.0 or later installed
3. [ASP.NET Core Runtime](https://dotnet.microsoft.com/en-us/download/dotnet/10.0/runtime) 10.0 or later installed
4. Microsoft SQL Express 2022, if hosting the database locally, or a separate SQL Standard or Enterprise edition server. (SQL express is installed by default)
...
![](../../.gitbook/assets/ui-page-directory-configuration-active-directory.png)
