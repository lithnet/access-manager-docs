...
![add\_disk](../../.gitbook/assets/Cluster-2-AddDisk.png) ![disk\_added](../../.gitbook/assets/Cluster-3-DiskAdded.png)
...
![installer\_paths](../../.gitbook/assets/Cluster-4-InstallerPaths.png)

* We also recommend using a group-managed service account for AMS. You must use the same account on all cluster nodes.

![service\_account](../../.gitbook/assets/Cluster-5-InstallerServiceAccount.png)
...
![cluster\_online](../../.gitbook/assets/Cluster-10-Online.png)
