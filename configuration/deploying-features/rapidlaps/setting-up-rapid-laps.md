...
_RapidLAPS_ integrates into the Windows login screen and admin consent prompts, allowing you to speed up the process when using the LAPS password.

With _RapidLAPS_, by simply scanning a QR code, or visiting the Access Manager web app and entering a PIN, you can remotely authorize and log into any LAPS-enabled computer without ever knowing the LAPS password. Once authorized, Access Manager securely transports the LAPS password between the server and the client, saving you from having to type out a long and complicated password.
...
AMS uses _agent policies_ to configure the behavior of Lithnet Access Manager agents.
...
![!](../../../.gitbook/assets/ui-page-authz-editsecurity-rapidlaps.png)
...
![](../../../.gitbook/assets/rapidlaps-login-screen.png)
...
![](../../../.gitbook/assets/rapidlaps-qr.png)
