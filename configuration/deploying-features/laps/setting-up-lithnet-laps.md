...
Access Manager requires an _encryption certificate_ to be configured, to facilitate encryption of sensitive passwords.
...
![](../../../.gitbook/assets/ui-page-access-manager-agent-agent-policies-windows-policies-edit-passwords-password.png)
