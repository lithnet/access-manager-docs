...
* Support for "passwordless" elevation and LAPS login with _RapidLAPS_ (Windows only)
...
* You wish to use the _RapidLAPS_ feature on Windows devices.
...
{% hint style="info" %}
**Use the&#x20;**_**password management**_**&#x20;features of the Lithnet Access Manager agent is optional**

For example, if you wish to keep using native Windows LAPS to manage passwords, but want to make use of features such as _RapidLAPS_, the AMS Agent can be configured to not manage passwords.

If the AMS Agent detects that either the _Windows LAPS client_ or the _legacy LAPS client_ is managing passwords on a device, it will _not_ attempt to manage local account passwords (to avoid conflicts).
{% endhint %}
...
| -------------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| Windows Vista, Windows 7 and Windows 8 | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   |
| Windows 8.1                            | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   |
| Windows 10                             | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Windows 11 and higher                  | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Windows Server 2012 R2                 | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   |
| Windows Server 2016                    | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
| Windows Server 2019 and higher         | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| macOS\[1]                              | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
| Linux\[1]                              | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |

_1. See the_ [_downloads page_](../installation/downloads.md) _for detailed operating system support for macOS and Linux agents._

## Supported join types

| Join type                             | Microsoft Legacy LAPS Agent        | Microsoft Windows LAPS Agent       | Lithnet Access Manager Agent       |
| ------------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| Active Directory joined devices       | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Entra ID joined devices               | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Non-domain joined devices (workgroup) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |

## Feature comparison

| Feature                                                | Microsoft Legacy LAPS Agent        | Microsoft Windows LAPS Agent       | Lithnet Access Manager Agent       |
| ------------------------------------------------------ | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| Regularly rotates the local admin password             | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Stores a history of previous local admin passwords     | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Stores passwords in plain-text                         | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png) 1 | ![](../.gitbook/assets/dash.png)   |
| Encrypts passwords                                     | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Writes passwords to Active Directory                   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   |
| Write passwords to Entra ID                            | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   |
| Write passwords to the AMS server                      | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
| Backups up BitLocker recovery keys to AMS              | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
| Enables passwordless login and elevation via RapidLAPS | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
...
| ---------------------------------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| Microsoft Legacy LAPS passwords stored in AD               | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
| Microsoft Windows LAPS passwords stored in AD              | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
| Microsoft Windows LAPS passwords stored in Microsoft Entra | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) | ![](../.gitbook/assets/check3.png) |
| Access Manager Agent passwords                             | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/dash.png)   | ![](../.gitbook/assets/check3.png) |
