...
<img src="../images/Cluster-6-GenericService.png" alt="generic_service" width="1000px"><br>
- Select `Lithnet Access Manager Service` from the services list

<img src="../images/Cluster-7-SelectService.png" alt="select_service" width="1000px"><br>
