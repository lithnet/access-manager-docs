...
<img src="../images/ui-page-authz-editsecurity-laps.png" alt="editsecurity_laps" width="1000px">

Add users and groups to this list and select the type of access they should be allowed or denied.

<img src="../images/badge-enterprise-edition-rocket.svg" alt="enterprise_edition"> Web-based access to local admin password history is an [Enterprise edition feature](Access-Manager-Editions)

#### Use a PowerShell script
<img src="../images/badge-enterprise-edition-rocket.svg" alt="enterprise_edition"> PowerShell-based authorization scripts are an [Enterprise edition feature](Access-Manager-Editions)
...
See the page on [Authorization scripts](/getting_started/Authorization-scripts) for more information on the script format.

### Local admin password settings
<img src="../images/ui-page-authz-laps-settings.png" alt="authz_laps"  width="1000px"><br>
